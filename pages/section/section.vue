		...
		<view v-if="!isDuanWang">
			<view class="section-content" v-for="(item,index) in list" :key='index'>
				<view class="section-cont01 flex flex-sb">
					...
					<view class="flex">
						<text class="section-con-ctxt01">{{item.page}}</text>
						<text class="section-con-ctxt02" @click="goZuoTi">开始做题</text>
					</view>
				</view>
				<view class="section-cont02" v-show="item.hide">
					<view class="section-cli01 flex flex-sb" v-for="(t,id) in item.sectionClass" :key='id'>
						<view class="flex section-con-cli01">
						...
						<view class="flex">
							<text class="section-con-ctxt01">{{t.page}}</text>
							<text class="section-con-ctxt02" @click="goZuoTi">去做题</text>
						</view>
					</view>
				</view>
			</view>
